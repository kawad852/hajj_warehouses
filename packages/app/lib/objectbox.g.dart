...
class ObjectBoxModel_ {
  ...
  static final id =
      obx.QueryIntegerProperty<ObjectBoxModel>(_entities[0].properties[0]);

  /// See [ObjectBoxModel.key].
  static final key =
      obx.QueryStringProperty<ObjectBoxModel>(_entities[0].properties[1]);

  /// See [ObjectBoxModel.data].
  static final data =
      obx.QueryStringProperty<ObjectBoxModel>(_entities[0].properties[2]);
}
