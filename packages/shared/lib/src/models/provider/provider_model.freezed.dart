...
class _$ProviderModelImpl implements _ProviderModel {
  ...
  @override
  String toString() {
    return 'ProviderModel(createdAt: $createdAt, id: $id, nameEn: $nameEn, nameAr: $nameAr, descriptionEn: $descriptionEn, descriptionAr: $descriptionAr, stateId: $stateId, cityId: $cityId, address: $address, status: $status, type: $type, thumbnail: $thumbnail, images: $images, phoneNumber: $phoneNumber, phoneCountryCode: $phoneCountryCode)';
  }
